...
ALTER TABLE `clientauth` ADD `roadType` VARCHAR(50) NOT NULL AFTER `password`, ADD `roadName` VARCHAR(50) NOT NULL AFTER `roadType`, ADD `depth` INT(30) NOT NULL AFTER `roadName`;
