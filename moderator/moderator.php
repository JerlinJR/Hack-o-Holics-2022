			...
			<nav class="side-navbar z-index-40">
				...
				<ul class="list-unstyled py-4">
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="stateHighway.php">
							<svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
								<use xlink:href="#portfolio-grid-1"> </use>
							</svg>State Highway </a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="districtHighway.php">
							<svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
								<use xlink:href="#portfolio-grid-1"> </use>
							</svg>District Highway</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="villageRoad.php">
							<svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
								<use xlink:href="#portfolio-grid-1"> </use>
							</svg>Village Road</a>
					</li>
					<li class="sidebar-item">
						<a class="sidebar-link" href="components.php">
							<svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
					...
					<li class="sidebar-item">
						...
						<ul class="collapse list-unstyled " id="exampledropdownDropdown">
							<li>
								<a class="sidebar-link" href="#">Page</a>
							</li>
							<li>
								<a class="sidebar-link" href="#">Page</a>
							</li>
